          ...
          <div className="container py-16 md:py-24">
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-2">
              <EventCard
                ...
                description="Sesi edukasi & workshop lingkungan untuk mahasiswa."
              />
              <EventCard
                slug="tumbler-challenge"
                title="Tumbler Challenge"
                imageSrc="/placeholder.svg"
                location="Seluruh Kampus"
                deadline="15 Sep 2025"
                description="Tantangan kurangi plastik sekali pakai dengan menggunakan tumbler."
              />
            </div>
          </div>
        </section>
